        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ScenarioPrompt = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AIScenarios", x => x.ScenarioId);
                    table.ForeignKey(
                        name: "FK_AIScenarios_Modules_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "Modules",
                        principalColumn: "ModuleId");
                    table.ForeignKey(
                        name: "FK_AIScenarios_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScenarioAttempts", x => x.AttemptId);
                    table.ForeignKey(
                        name: "FK_ScenarioAttempts_AIScenarios_ScenarioId",
                        column: x => x.ScenarioId,
                        principalTable: "AIScenarios",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIScenarios_ModuleId",
                table: "AIScenarios",
                column: "ModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_AIScenarios_RoleId",
                table: "AIScenarios",
                column: "RoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScenarioAttempts_UserId",
                table: "ScenarioAttempts",
                column: "UserId");
